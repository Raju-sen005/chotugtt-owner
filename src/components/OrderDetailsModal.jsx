...
export default function OrderDetailsModal({ order, onClose }) {
  ...
  return (
    <>
      {showPrintPopup && (
        <div className="no-print fixed inset-0 z-[10000] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
          <div className="w-full max-w-sm bg-white rounded-3xl shadow-2xl p-6">
            ...
            <h3 className="text-lg font-black text-slate-900">Print KOT?</h3>

            <p className="text-sm text-slate-500 mt-2 leading-relaxed">
              Are you sure you want to print the Kitchen Order Ticket for{" "}
              <span className="font-bold text-slate-700">{order.orderId}</span>?
            </p>
